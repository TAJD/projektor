...
sidebar:
  order: 2
---
<!-- GENERATED by apps/api/scripts/gen-mcp-catalog.ts — DO NOT EDIT BY HAND. -->
<!-- Run `pnpm --filter @projektor/api gen:catalog` after changing any mcp/*.ts tool. -->

**64 tools across 14 domains.** All inputs/outputs are JSON. Generated from `apps/api/src/mcp/*.ts` and freshness-checked by CI, so it always matches the running server.
