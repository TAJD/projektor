...
- **A running projektor instance.** Follow the deploy template in [`deploy-template/`](../deploy-template/) or the [self-hosting guide](../README.md#self-hosting-in-5-minutes).
