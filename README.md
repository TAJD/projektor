...
See the **[agent connection guide](https://tajd.github.io/projektor/agents/mcp-connection/)** for the full connection guide, protocol reference, and tool catalog (<!-- gen-mcp-stats:start -->96 tools across 21 domains<!-- gen-mcp-stats:end --> - project data plus agent-coordination primitives).
